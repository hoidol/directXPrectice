...
bool SystemClass::Frame()
{
	...
	{
		this->m_Graphics->m_Camera->AdjustPosition(this->m_Graphics->m_Camera->GetForwardVector() * 0.1f);
	}
	if (m_Input->IsKeyDown('S'))
	{
		this->m_Graphics->m_Camera->AdjustPosition(this->m_Graphics->m_Camera->GetBackwardVector() * 0.1f);
	}
	if (m_Input->IsKeyDown('A'))
	{
		this->m_Graphics->m_Camera->AdjustPosition(this->m_Graphics->m_Camera->GetLeftVector() *  0.1f);
	}
	if (m_Input->IsKeyDown('D'))
	{
		this->m_Graphics->m_Camera->AdjustPosition(this->m_Graphics->m_Camera->GetRightVector() *  0.1f);
	}
...
void SystemClass::InitializeWindows(int& screenWidth, int& screenHeight)
{
	...
	// 프로그램 이름을 지정합니다
	m_applicationName = L"Dx11Demo_07";
